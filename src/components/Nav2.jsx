...
const Navbar = () => {
 ...
 const handleclick=()=>{setclick(!click)} ;
  ...
  return (
    <div style={{display:'flex' , justifyContent:'space-between' ,height:'10%', top:'0px' ,margin:'10px' }}  >
      ...
      {/* <ul className={islaptopview ?'flex':(click?'row':'column')} style={{ listStyleType:'none'}} > */}
      {/* <ul className='navul' > */}
       ...
       <div>
         <Link to={"/Contact"}>
           <h3 style={{fontWeight:'5px'}} >Contact</h3>
         </Link>
       </div>
